...
//fill review and author in an instance of spots, but also fill author in the review
...
module.exports.updateSpot = async (req, res) => {
    ...
    //...spread operator,将一个数组或对象展开为他们的各个元素，以便能够轻松地合并，复制或传递参数
    ...
    req.flash('success', 'Successfully updated Vacation Destinations!');
    res.redirect(`/spots/${spot._id}`)
}
...
module.exports.deleteSpot = async (req, res) => {
    ...
    req.flash('success', 'Successfully deleted Vacation Destinations')
    res.redirect('/spots');
}